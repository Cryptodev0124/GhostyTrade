...
describe('Trade', () => {
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(ethTokens.wbnb, '1'), new TokenAmount(ethTokens.cake, '1'))],
  //         [PairState.INVALID, new Pair(new TokenAmount(ethTokens.busd, '1'), new TokenAmount(ethTokens.cake, '1'))],
  //         [PairState.LOADING, new Pair(new TokenAmount(ethTokens.busd, '1'), new TokenAmount(ethTokens.wbnb, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(ethTokens.wbnb, ethTokens.cake)
  //         return {
  //           pairs,
  //         }
  //       })
  //       expect(result.current.pairs).toStrictEqual([
  //         new Pair(new TokenAmount(ethTokens.wbnb, '1'), new TokenAmount(ethTokens.cake, '1')),
  //       ])
  //     })
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(ethTokens.wbnb, '1'), new TokenAmount(ethTokens.cake, '1'))],
  //         [PairState.EXISTS, new Pair(new TokenAmount(ethTokens.wbnb, '1'), new TokenAmount(ethTokens.cake, '1'))],
  //         [PairState.EXISTS, new Pair(new TokenAmount(ethTokens.cake, '1'), new TokenAmount(ethTokens.wbnb, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(ethTokens.wbnb, ethTokens.cake)
  ...
  //       renderHook(() => {
  //         Trades.useAllCommonPairs(ethTokens.wbnb, ethTokens.cake)
  //       })
  ...
  //       mockUsePairs.mockClear()
  //       renderHook(() => {
  //         Trades.useAllCommonPairs(ethTokens.wbnb, ethTokens.wbnb)
  //       })
  //       expect(mockUsePairs).toMatchSnapshot()
  //     })
  //   })
  ...
  //       const allowPairs = [new Pair(new TokenAmount(ethTokens.wbnb, '1'), new TokenAmount(ethTokens.cake, '1'))]
  //       const argA = CurrencyAmount.ether('1000000')
  //       const argB = ethTokens.cake
  //       renderHook(
  //         () => {
