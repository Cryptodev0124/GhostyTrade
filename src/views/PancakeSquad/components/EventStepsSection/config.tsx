...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold GHOSTTY'),
      bodyText: [t('Each NFT costs GHOSTTY to mint. Remember you also need ETH to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="/swap?outputCurrency=0x8452c14f610DaBd23C3da8A810aBB55E71F137d3&chainId=1"
            target="_blank"
            width="100%"
          >
            {t('Buy GHOSTTY')}
