      ...
      <S.Inner>
        <S.LeftWrapper>
          {/* {status === FetchStatus.Fetched && isLotteryLive(data.status) ? (
            ...
            <> */}
          <S.StyledSubheading>{t('Ghostty ADs')}</S.StyledSubheading>
          <S.StyledHeading scale="xl">{t('Get your ad now')}</S.StyledHeading>
          {/* </>
          )} */}
          <NextLinkFromReactRouter to="https://t.me/cryptodev0615">
            <Button>
        ...
        <RightWrapper>
          {isDesktop ? (
            <img src="/images/lottery1.png" alt="LotteryBanner" width={1112} height={192 + 32} placeholder="blur" />
          ) : (
            <img
              className="mobile"
              src="/images/lotteryMobile1.png"
              alt="LotteryBanner"
              width={190}
              height={144}
              placeholder="blur"
