...
const CommitTokenSection: React.FC<React.PropsWithChildren<TokenSectionProps & { commitToken: Token }>> = ({
  ...
  if (commitToken.equals(cakeBnbLpToken)) {
    return <TokenSection primaryToken={ethTokens.cake} secondaryToken={ethTokens.wbnb} {...props} />
  }
          ...
          <Box>
            <MessageText display="inline">
              {publicIfoData.status === 'finished'
                ? t('Activate GhostyTrade Profile to take part in next IFO‘s!')
                : t('You need an active GhostyTrade Profile to take part in an IFO!')}
            </MessageText>{' '}
